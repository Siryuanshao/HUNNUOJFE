      ...
      <el-col :span="6">
        <div class="sidebar">
          <el-card>
            ...
            <div style="margin-top: 10px;">
              <el-button @click="handleSummary" style="width: 100%;">Summary</el-button>
            </div>
  ...
  export default {
    ...
    methods: {
      init: function () {
        ...
        api.getProblemDetail(pid).then(res => {
...
<style lang="scss" scoped>
  .problem-detail {
    ...
    .description, .input, .output, .source, .hint{
      font-size: 15px;
    }
